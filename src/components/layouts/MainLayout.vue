<template>
  ...
  <div class="btm-nav sm:hidden">
    ...
    <button
      ...
      :class="$route.name === 'home' ? 'active text-primary' : ''"
    >
      <svg
        xmlns="http://www.w3.org/2000/svg"
        height="24"
        viewBox="0 -960 960 960"
        :class="$route.name === 'home' ? 'fill-primary' : ''"
      >
        <path
    ...
    <!-- Transactions -->
    <button :class="$route.name === 'transactions' ? 'active text-primary' : ''">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        height="24"
        viewBox="0 -960 960 960"
        width="24"
        :class="$route.name === 'transactions' ? 'fill-primary' : ''"
      >
        <path
    ...
    <!-- Reports -->
    <button :class="$route.name === 'reports' ? 'active text-primary' : ''">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        height="24"
        viewBox="0 -960 960 960"
        width="24"
        :class="$route.name === 'reports' ? 'fill-primary' : ''"
      >
        <path
    ...
    <button
      ...
      :class="$route.name === 'profile' ? 'active text-primary' : ''"
    >
      <svg
        xmlns="http://www.w3.org/2000/svg"
        height="24"
        viewBox="0 -960 960 960"
        width="24"
        :class="$route.name === 'profile' ? 'fill-primary' : ''"
      >
        <path
